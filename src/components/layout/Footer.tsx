...
export function Footer() {
  ...
  return (
    <footer className="relative bg-[#18181B] border-t border-[#27272A] py-8 sm:py-12 px-4 sm:px-6 lg:px-8 z-10 font-mono text-xs text-[#94A3B8]">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6 text-center sm:text-left">
        <div className="flex items-center space-x-2">
          <Terminal className="h-4 w-4 text-[#00F5A0] shrink-0" />
          <span>
            © {currentYear} <strong className="text-[#F8FAFC]">Thomas Marinheiro</strong>
          </span>
        </div>
        ...
        <div className="flex items-center space-x-5">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center space-x-1 hover:text-[#00F5A0] transition-colors"
          >
          ...
          <a href="#hero" className="flex items-center space-x-1 text-[#00F5A0] hover:underline">
